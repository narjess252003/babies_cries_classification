...
img_size = 128  # Size of the image (128x128)
...
# Reshaping for LSTM (reshape from [samples, height, width, 1] to [samples, timesteps, features])
X = X.reshape(X.shape[0], img_size, img_size)  # Timesteps = img_size, Features = img_size
